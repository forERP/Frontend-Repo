export const menus = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'inventory-list', label: '재고 조회', path: '/inventory', permissionCode: 'INVENTORY_VIEW' },
      { key: 'inventory-item', label: '재고 상세', path: '/inventory/store-products/:storeProductId', hidden: true, permissionCode: 'INVENTORY_DETAIL' },
  ...
  },
  {
    ...
    children: [
      { key: 'store-list', label: '매장 조회', path: '/stores', permissionCode: 'STORE_LIST_VIEW' },
      ...
      { key: 'warehouse-list', label: '창고 조회', path: '/warehouses', permissionCode: 'WAREHOUSE_LIST_VIEW' },
  ...
  },
  {
    ...
    children: [
      { key: 'suppliers-list', label: '거래처 목록', path: '/suppliers', permissionCode: 'SUPPLIER_VIEW' },
      { key: 'suppliers-create', label: '거래처 등록', path: '/suppliers/new', permissionCode: 'SUPPLIER_CREATE' },
      { key: 'suppliers-detail', label: '거래처 상세', path: '/suppliers/:id', hidden: true, permissionCode: 'SUPPLIER_VIEW' },
    ],
  },
  {
    key: 'purchase',
    ...
    children: [
      { key: 'purchase-requests', label: '발주 요청 조회', path: '/purchase-requests', permissionCode: 'PURCHASE_REQUEST_VIEW' },
  ...
  },
  {
    ...
    children: [
      { key: 'orders', label: '주문 조회', path: '/orders', permissionCode: 'ORDER_LIST_VIEW' },
      { key: 'order-detail', label: '주문 상세', path: '/orders/:id', hidden: true, permissionCode: 'ORDER_DETAIL_VIEW' },
      { key: 'outbounds', label: '출고 조회', path: '/outbounds', permissionCode: 'OUTBOUND_VIEW' },
  ...
  },
  {
    ...
    children: [
      { key: 'shipments-list', label: '배송 조회', path: '/shipments', permissionCode: 'SHIPMENT_VIEW' },
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'user-detail', label: '직원 상세', path: '/users/:userId', hidden: true, permissionCode: 'USER_VIEW' },
      { key: 'user-edit', label: '직원 수정', path: '/users/:userId/edit', hidden: true, permissionCode: 'USER_VIEW' },
