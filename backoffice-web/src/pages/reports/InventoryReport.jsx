...
// import { fetchInventoryReport } from '../../api/inventoryReportApi';
...
export default function InventoryReport() {
  ...
  const loadReport = async (overrideFilters) => {
    try {
      setLoading(true);
      setError(null);
  ...
  return (
    <div className="inventory-report-page">
      ...
      <section className="inventory-report-table-card">
        ...
        {error && (
          <div className="inventory-report-error">
            {error}
          </div>
        )}
