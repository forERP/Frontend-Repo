...
const menuData = {
    set: [
        { id: 1, name: "빵1", price: 8500 },
        { id: 2, name: "빵2", price: 9000 },
        { id: 3, name: "빵3", price: 8800 },
        { id: 4, name: "빵4", price: 9500 },
    ],
    burger: [
        { id: 1, name: "패티1", price: 4500 },
        { id: 2, name: "패티2", price: 4800 },
        { id: 3, name: "패티3", price: 5000 },
        { id: 4, name: "패티4", price: 5500 },
    ],
    side: [
    ...
    drink: [
        { id: 1, name: "콜라 시럽", price: 2000 },
        { id: 2, name: "사이다 시럽", price: 2000 },
        { id: 3, name: "커피 콩", price: 2500 },
    ...
    return (
        <div className="menu-layout">
            <div className="menu-main">
                ...
                <div className="menu-category">
                    <div className="category-buttons">
                        <button onClick={() => navigate("/dispose/set")}>세트</button>
                        <button onClick={() => navigate("/dispose/burger")}>햄버거</button>
                        <button onClick={() => navigate("/dispose/side")}>사이드</button>
                        <button onClick={() => navigate("/dispose/drink")}>음료</button>
                    </div>
            ...
            <div className="menu-footer">
                ...
                <button className="pay-btn">폐기</button>
            </div>
        </div>
    );
}
